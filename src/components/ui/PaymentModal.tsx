      ...
      <div className="modal-card pm-card" role="dialog" aria-modal="true" aria-label="Choose payment method" onClick={e => e.stopPropagation()}>
        ...
        {method === 'crypto' && (
          <div className="pm-note">
            You will be redirected to Cryptomus to complete your <strong>${price.toFixed(2)}</strong> payment securely. Your plan activates automatically once the payment is confirmed.
          </div>
        )}
